...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('SoftuniBlogBundle:Author')->findAll();

        return $this->render('SoftuniBlogBundle:author:index.html.twig', array(
            'authors' => $authors,
        ));
    }
    ...
    {
        $author = new Author();
        $form = $this->createForm('SoftuniBlogBundle\Form\AuthorType', $author);
        ...
        return $this->render('SoftuniBlogBundle:author:new.html.twig', array(
            'author' => $author,
    ...
    public function showAction(Author $author)
    {
        ...
        return $this->render('SoftuniBlogBundle:author:show.html.twig', array(
            'author' => $author,
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('SoftuniBlogBundle\Form\AuthorType', $author);
        ...
        return $this->render('SoftuniBlogBundle:author:edit.html.twig', array(
            'author' => $author,
